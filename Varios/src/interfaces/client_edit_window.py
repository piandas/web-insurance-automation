...
class ClientEditWindow:
    ...
    def _get_available_fondos_from_images(self) -> List[str]:
        ...
        try:
            ...
            # Ruta a las plantillas (subir 4 niveles: interfaces -> src -> Varios -> raíz)
            base_path = Path(__file__).parent.parent.parent.parent
            templates_path = base_path / "Plantillas"
            ...
            try:
                # parent x4 sale de interfaces -> src -> Varios -> raíz
                logos_path = Path(__file__).parent.parent.parent.parent / "Varios" / "docs" / "IMAGENES FONDOS"
